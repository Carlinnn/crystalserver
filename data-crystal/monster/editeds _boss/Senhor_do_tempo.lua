...
monster.attacks = {
	...
	{ name = "combat", interval = 400, chance = 70, type = COMBAT_MANADRAIN,
		minDamage = 1000, maxDamage = 5210, range = 9, target = true },

	{ name = "combat", interval = 2000, chance = 25, type = COMBAT_ENERGYDAMAGE,
		minDamage = 4200, maxDamage = 6300, length = 10, spread = 9,
		effect = CONST_ME_BIGCLOUDS, target = true },

	{ name = "warlock skill reducer", interval = 1000, chance = 40, range = 6, target = false },

	{ name = "combat", interval = 2000, chance = 10, type = COMBAT_MANADRAIN,
		minDamage = 0, maxDamage = -120, range = 7, target = false },

	{ name = "combat", interval = 2000, chance = 20, type = COMBAT_FIREDAMAGE,
		minDamage = -50, maxDamage = -180, range = 7, radius = 3,
		shootEffect = CONST_ANI_BURSTARROW, effect = CONST_ME_FIREAREA, target = true },

	{ name = "firefield", interval = 2000, chance = 10, range = 7, radius = 2,
		shootEffect = CONST_ANI_FIRE, target = true },

	{ name = "combat", interval = 2000, chance = 10, type = COMBAT_ENERGYDAMAGE,
		minDamage = -150, maxDamage = -230, length = 8, spread = 0,
		effect = CONST_ME_BIGCLOUDS, target = false },

	{ name = "speed", interval = 100, chance = 100, speedChange = -53000,
		range = 1, effect = CONST_ME_MAGIC_RED, target = false, duration = 2000 },

	{ name = "speed", interval = 200, chance = 100, speedChange = -100000,
		range = 1, radius = 4, shootEffect = CONST_ANI_POISON,
		effect = CONST_ME_GREEN_RINGS, target = true, duration = 1500 }
}
