...
monster.outfit = {
look type="131" head="38" body="0" legs="0" feet="0" addons="3" mount="372"
}
...
monster.attacks = {
	{ name = "melee", interval = 100, chance = 1000, minDamage = 1000, maxDamage = -4000 },
}
...
monster.defenses = {
    ...
    { name = "combat", interval = 200, chance = 100, type = COMBAT_PHYSICALDAMAGE, minDamage = 0, maxDamage = -200, range = 15, shootEffect = CONST_ANI_SPEAR, target = false },
}
